  ...
  <nav className="bg-white border-b-2 border-gray-200 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
    <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div id="mobile-nav" className="flex md:order-2">
        ...
        {/* dark-mode button ended */}

        {/* button - magnifying glass icon for mobile users */}
        <button
        ...
        {/* button - magnifying glass icon ended */}

        {/* button - search for desktop users */}
        ...
        {/* button - open (three horizontal lines) mobile menu */}
        <button
          onClick={() => setHidden(!hidden)}
          data-collapse-toggle="navbar-search"
          type="button"
        ...
        {/* button - open (three horizontal lines) ended */}
      </div>
      {/* end */}

      {/* start - fours' */}
      <div
        id="navbar-search" className={`${hidden ? "hidden" : ""} items-center justify-between w-full md:flex md:w-auto md:order-1`}
      >
